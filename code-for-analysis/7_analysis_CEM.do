...
cap mkdir "`logdir'"
log using "`logdir'/Mainresults_CEM_${S_DATE}.log", replace text

local out "`resdir'/Results_CEM.xlsx"
...
* ------------------------------- Wave 1996 -------------------------------
use "`datadir'/Wave1996_CEM.dta", clear
...
* ------------------------------- Wave 2004 -------------------------------
use "`datadir'/Wave2004_CEM.dta", clear
...
* ------------------------------- Wave 2007 -------------------------------
use "`datadir'/Wave2007_CEM.dta", clear

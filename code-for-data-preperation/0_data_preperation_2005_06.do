* ******************************************************************** *
   ...
   * ******************************************************************** *
       /*
       ** PURPOSE: The purpose of the project is to clean the individual record data from DHS 2005-2006
       ** OUTLINE:      
...
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/1_raw/2005-06/IA_2005-06_DHS_09252023_1812_94372/IABR52DT/IABR52FL.dta", replace
keep v000 v001 v002 v003 v005 v006 v007 v008 v201 v212 b0 b1 b4 b5 bord caseid b2 b3 s356 v107 v011 v012 v013 v024 v025 v020 v026 s310c
...
ren v201 ceb
keep if ceb>=2
*keep only those women that second birth by 2001. Why do we do this-since the survey is done in 2006. We want to give a woman atleast 5 years of time to have child 3.
keep if year_birth2<=2001
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_mother_2005_06.dta", replace
***********************************************************************************
*PART 2: Load the household dataset and trim dataset
***********************************************************************************
use hhid hv000 hv001 hv002 hv003 sh45 sh44 hv270  using "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/1_raw/2005-06/IA_2005-06_DHS_09252023_1812_94372/IAHR52DT/IAHR52FL.dta", clear
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_household_2005_06.dta", replace

***********************************************************************************
* Merge Household and Mother Records
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_mother_2005_06.dta", clear
merge m:1 hhid using "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_household_2005_06.dta"
keep if _merge==3
drop _merge
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_2005_06.dta", replace

***********************************************************************************
*PART 3: Relevant Variables
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_2005_06.dta", clear
...
replace state = regexr(state, "\[[a-z]+\] ", "")
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/3_processed/merged_2005_06_all.dta", replace

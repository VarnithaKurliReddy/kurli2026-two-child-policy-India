* ******************************************************************** *
   ...
   * ******************************************************************** *
       /*
       ** PURPOSE: The purpose of the project is to clean the individual record data from DHS 2015-2016
       ** OUTLINE:      
...
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/1_raw/2015-16/IABR74DT/IABR74FL.DTA", replace
keep v000 v001 v002 v003 v005 v006 v007 v008 v201 v212 b0 b1 b4 b5 bord caseid b2 b3 s361 s356 v107 v011 v012 v013 v024 v025 sdistri v020 v026 s314c
...
ren v201 ceb
keep if ceb>=2
*keep only those women that second birth by 2011. Why do we do this-since the survey is done in 2016. We want to give a woman atleast 5 years of time to have child 3.
keep if year_birth2<=2011
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_mother_2015_16.dta", replace
***********************************************************************************
*PART 2: Load the household dataset and trim dataset
***********************************************************************************
use hhid hv000 hv001 hv002 hv003 sh49 sh47 sv270us sv270rs  using "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/1_raw/2015-16/IAHR74DT/IAHR74FL.DTA", clear
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_household_2015_16.dta", replace

***********************************************************************************
* Merge Household and Mother Records
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_mother_2015_16.dta", clear
merge m:1 hhid using "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_household_2015_16.dta"
keep if _merge==3
drop _merge
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_2015_16.dta", replace

***********************************************************************************
*PART 3: Relevant Variables
***********************************************************************************
use "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/2_interim/trimmed_2015_16.dta", clear
...
gen treatment=(v024==27) & (year_birth2>2003)
...
save "/Users/varnithakurli/Library/CloudStorage/Dropbox/Boulder/Research/1.Fertility/Fertlity Limits/1_data/3_processed/merged_2015_16_all.dta", replace
